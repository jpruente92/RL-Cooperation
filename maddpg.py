...
def maddpg(multi_agent, env, brain_name,nr_agents):
    ...
    for i_episode in range(1, MAX_NR_EPISODES+1):
        ...
        print('Episode {}\tTime {}\tScore this episode (maximum over agents): {:.2f}\tAverage Score last 100 episodes (maximum over agents): {:.2f}'.format(i_episode,time_for_episode,score_this_episode, np.mean(scores_window)))
